...
import { CommercialHero } from '@/app/components/commercial/commercial-hero';
import { CommercialBenefits } from '@/app/components/commercial/commercial-benefits';
import { CommercialProcess } from '@/app/components/commercial/commercial-process';
import { CommercialCTA } from '@/app/components/commercial/commercial-cta';
import { Briefcase, Shield, Users, Clock, Star, Award, Building2 } from 'lucide-react';
...
export function CommercialPressureCleaningContent() {
  const benefits = [
    {
      icon: Briefcase,
