...
export const metadata: Metadata = {
  title: {
    absolute: 'Playground Pressure Cleaning Perth | PPS Exterior Cleaning',
  },
  description:
  ...
  openGraph: { url: `${SITE_URL}/commercial/playground-cleaning`, type: 'website', locale: 'en_AU', siteName: 'PPS Exterior Cleaning', images: [{ url: 'https://www.ppsexteriorcleaning.com.au/og-image.jpg', width: 1200, height: 630 }] },
};
