...
export default function QuinnsRocks() {
  const faqSchema = generateSuburbFAQSchema('Quinns Rocks');
  ...
  return (
    <>
      ...
      <SuburbHero suburbName="Quinns Rocks" tagline="Pressure Cleaning Quinns Rocks - Coastal Specialists" description="Expert pressure cleaning for Quinns Rocks' beachside properties. Professional services designed for coastal living and salt spray protection." />
      <SuburbServices suburbName="Quinns Rocks" />
      <BeforeAfterGallery />
      <SuburbWhyChoose suburbName="Quinns Rocks" />

      <SuburbProcess suburbName="Quinns Rocks" />

      <SuburbFAQ suburbName="Quinns Rocks" />
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0a1628] mb-8 text-center">About Pressure Cleaning in Quinns Rocks</h2>
            <div className="prose prose-lg max-w-none space-y-6 text-gray-700">
              <p>Quinns Rocks' beautiful beachside location requires specialized pressure cleaning expertise. Our professional services combat salt spray and coastal conditions to protect your property investment.</p>
              <div className="bg-[#00d4ff]/10 border-l-4 border-[#00d4ff] p-6 mt-8">
                ...
                <p className="mb-0">First-time customers in Quinns Rocks receive 10% off their first pressure cleaning service. Call us today on <a href="tel:+61452579657" className="text-[#00d4ff] font-semibold hover:underline">0452 579 657</a> to book.</p>
              </div>
            </div>
          </div>
        </div>
