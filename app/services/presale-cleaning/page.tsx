...
import { PresaleBeforeAfter } from '@/app/components/service/presale-before-after';
...
export const metadata: Metadata = {
  ...
  openGraph: { url: `${SITE_URL}/services/presale-cleaning`, type: 'website', locale: 'en_AU', siteName: 'Premier Pressure Solutions WA', images: [{ url: 'https://www.premierpressuresolutions.com.au/og-image.jpg', width: 1200, height: 630 }] },
};
...
export default function PresaleCleaningPage() {
  const serviceData = {
    ...
    subtitle:
      'Maximum impact cleaning that increases property value and helps secure bonds',
    metaDescription:
      'Professional pre-sale and end of lease cleaning in Perth. Complete exterior transformation. Boost property value. Secure your bond. Free quotes.',
...
Unlike basic cleaning services, our pre-sale and end of lease package is thorough and comprehensive. We don't just clean the obvious areas—we target every detail that buyers and property managers notice. Mouldy eaves, stained driveways, dirty windows, and algae-covered paths all detract from your property's appeal and value. Our systematic approach addresses all these issues, presenting your property in its absolute best condition and maximizing your return on investment whether you're selling or moving out.`,
    ...
    process: [
      {
        ...
        description:
          'We conduct a comprehensive inspection of all exterior areas, identifying every surface requiring cleaning and discussing your specific requirements and timeline.',
      },
      {
        title: 'Customized Cleaning Plan',
        description:
          'Based on your property type and goals (pre-sale or end of lease), we create a detailed cleaning plan covering all necessary areas to meet your objectives.',
      },
      {
        title: 'Comprehensive Exterior Clean',
        description:
          'Our team systematically cleans all exterior surfaces—house walls, roof, gutters, driveway, paths, patio, deck, fences, and windows—using appropriate methods for each surface.',
      },
      {
        title: 'Detail Work & Problem Areas',
        description:
          'We focus on commonly overlooked details like eaves, downpipes, outdoor fixtures, garage doors, and garden edges that property managers and buyers always notice.',
      },
      {
        title: 'Final Inspection & Sign-off',
        description:
          'We conduct a thorough final check ensuring every area meets our high standards. You receive before and after photos documenting the transformation.',
      },
    ],
  ...
  const combinedSchema = combineSchemas(
    generateLocalBusinessSchema(),
    generateServiceSchema(
      'Pre-Sale & End of Lease Cleaning Perth',
