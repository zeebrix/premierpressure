...
export const metadata: Metadata = {
  title: {
    absolute: 'Perth Pressure Cleaning Pricing Guide 2026 | Cost Estimates & Factors',
  },
  description:
...
const structuredData = {
  ...
  description:
    'Comprehensive pricing guide for pressure cleaning services in Perth. Understand costs, factors that affect pricing, and get accurate estimates for your project.',
              ...
              {[
                {
                  ...
                  description:
                    'Larger areas require more time, water, and equipment usage. Different surfaces (concrete vs. limestone) require different pressure levels and cleaning solutions, affecting both time and cost.',
                },
                {
                  title: '2. Condition & Severity of Dirt',
                  description:
                    'Heavy mould, deep oil stains, or years of neglect require pre-treatment, multiple passes, and specialized cleaning solutions. Light maintenance cleaning is significantly faster and cheaper.',
                },
                {
                  title: '3. Accessibility & Height',
                  description:
                    'Hard-to-reach areas like second-story roofs, tight side passages, or properties with limited water access require additional equipment and safety measures, increasing costs.',
                },
                {
                  title: '4. Property Location',
                  description:
                    'Travel time to remote suburbs, parking restrictions, or difficult site access can affect pricing. Most Perth metro area properties are within standard service zones.',
                },
                {
                  title: '5. Additional Services',
                  description:
                    'Sealing pavers after cleaning, gutter cleaning, or applying protective treatments adds value but increases the total investment.',
                },
                {
                  title: '6. Equipment & Technique Required',
                  description:
                    'Delicate surfaces require soft washing equipment and eco-friendly chemicals. Commercial-grade jobs need industrial equipment, all factored into pricing.',
                },
                {
                  title: '7. Time & Urgency',
                  description:
                    'Same-day or emergency services, weekend work, or pre-sale rush jobs may incur premium rates. Booking in advance offers better value.',
                },
              ].map((factor, index) => (
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-red-50 rounded-xl p-6 border border-red-200">
                ...
                <p className="text-sm text-red-800 font-semibold">
                  Typical red flag: &quot;Full house wash $100&quot; for a 4-bedroom home
                </p>
              </div>
              ...
              <div className="bg-red-50 rounded-xl p-6 border border-red-200">
                ...
                <p className="text-sm text-red-800 font-semibold">
                  Always insist on written documentation
                </p>
              </div>
              ...
              <div className="bg-red-50 rounded-xl p-6 border border-red-200">
                ...
                <p className="text-sm text-red-800 font-semibold">
                  Standard terms: Pay on completion or small deposit
                </p>
              </div>
