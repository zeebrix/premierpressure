...
const beforeAfterData = [
  {
    before: 'https://images.unsplash.com/photo-1698562728786-4ad832356f14?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800',
    after: 'https://images.unsplash.com/photo-1768765397301-8a64df3d41ac?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800',
    location: 'Applecross',
    description: 'Concrete driveway restoration',
  },
  {
    before: 'https://images.unsplash.com/photo-1685555808291-8be049d2add0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800',
    after: 'https://images.unsplash.com/photo-1763392199731-e090a7288c51?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800',
    location: 'Nedlands',
    description: 'Paver cleaning and restoration',
  },
  {
    ...
    location: 'Cottesloe',
    description: 'Deck restoration',
  },
];

export function ServiceBeforeAfter({ serviceName }: ServiceBeforeAfterProps) {
