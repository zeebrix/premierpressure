...
export default function Brabham() {
  const faqSchema = generateSuburbFAQSchema('Brabham');
  ...
  return (
    <>
      ...
      <StickyCallButton />
      <SuburbHero suburbName="Brabham" tagline="Pressure Cleaning Brabham - Modern Estate Care" description="Professional pressure cleaning for Brabham's contemporary family homes. Expert services for this thriving new development." />
      <SuburbServices suburbName="Brabham" />
      
      <BeforeAfterGallery />

      <SuburbWhyChoose suburbName="Brabham" />

      <SuburbProcess suburbName="Brabham" />

      <SuburbFAQ suburbName="Brabham" />
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0a1628] mb-8 text-center">About Pressure Cleaning in Brabham</h2>
            <div className="prose prose-lg max-w-none space-y-6 text-gray-700">
              <p>Brabham's modern estates and family-friendly community benefit from professional pressure cleaning services. We deliver quality results for new homes, driveways, and outdoor living spaces.</p>
              <div className="bg-[#00d4ff]/10 border-l-4 border-[#00d4ff] p-6 mt-8">
                ...
                <p className="mb-0">First-time customers in Brabham receive 10% off their first pressure cleaning service. Call us today on <a href="tel:+61452579657" className="text-[#00d4ff] font-semibold hover:underline">0452 579 657</a> to book.</p>
              </div>
            </div>
          </div>
        </div>
