...
export default function Alkimos() {
  const faqSchema = generateSuburbFAQSchema('Alkimos');
  ...
  return (
    <>
      ...
      <StickyCallButton />
      <SuburbHero suburbName="Alkimos" tagline="Pressure Cleaning Alkimos - New Home Specialists" description="Expert pressure cleaning for Alkimos' modern homes and coastal properties. Professional services for Perth's fastest-growing beachside suburb." />
      <SuburbServices suburbName="Alkimos" />
      
      <BeforeAfterGallery />

      <SuburbWhyChoose suburbName="Alkimos" />

      <SuburbProcess suburbName="Alkimos" />

      <SuburbFAQ suburbName="Alkimos" />
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0a1628] mb-8 text-center">About Pressure Cleaning in Alkimos</h2>
            <div className="prose prose-lg max-w-none space-y-6 text-gray-700">
              <p>Alkimos' brand-new homes and beachside location require professional pressure cleaning to maintain their pristine appearance. We provide expert services for modern properties and coastal conditions.</p>
              <div className="bg-[#00d4ff]/10 border-l-4 border-[#00d4ff] p-6 mt-8">
                ...
                <p className="mb-0">First-time customers in Alkimos receive 10% off their first pressure cleaning service. Call us today on <a href="tel:+61452579657" className="text-[#00d4ff] font-semibold hover:underline">0452 579 657</a> to book.</p>
              </div>
            </div>
          </div>
        </div>
