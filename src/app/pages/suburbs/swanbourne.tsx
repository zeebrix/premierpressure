...
export default function Swanbourne() {
  const faqSchema = generateSuburbFAQSchema('Swanbourne');
  ...
  return (
    <>
      ...
      <SuburbHero suburbName="Swanbourne" tagline="Pressure Cleaning Swanbourne - Premium Beachside Care" description="Expert pressure cleaning for Swanbourne's prestigious beachside homes. Professional services for Perth's exclusive coastal suburb." />
      <SuburbServices suburbName="Swanbourne" />
      <BeforeAfterGallery />
      <SuburbWhyChoose suburbName="Swanbourne" />

      <SuburbProcess suburbName="Swanbourne" />

      <SuburbFAQ suburbName="Swanbourne" />
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0a1628] mb-8 text-center">About Pressure Cleaning in Swanbourne</h2>
            <div className="prose prose-lg max-w-none space-y-6 text-gray-700">
              <p>Swanbourne's prestigious beachside properties require professional pressure cleaning to combat salt air and maintain their premium appearance. We provide expert services for exclusive coastal homes and high-value properties.</p>
              <div className="bg-[#00d4ff]/10 border-l-4 border-[#00d4ff] p-6 mt-8">
                ...
                <p className="mb-0">First-time customers in Swanbourne receive 10% off their first pressure cleaning service. Call us today on <a href="tel:+61452579657" className="text-[#00d4ff] font-semibold hover:underline">0452 579 657</a> to book.</p>
              </div>
            </div>
          </div>
        </div>
