...
import { DrivewayBeforeAfter } from '@/app/components/service/driveway-before-after';
...
export default function DrivewayCleaningPage() {
  const serviceData = {
    ...
    subtitle:
      "Expert pressure cleaning services that restore your driveway's appearance and increase your property value",
    metaDescription:
      'Professional driveway cleaning services in Perth. Remove oil stains, mould, and grime with our expert pressure cleaning. Free quotes. Fully insured.',
    ...
    process: [
      {
        title: 'Inspection',
        description:
          "We assess your driveway's condition, identify problem areas, and determine the best cleaning approach for your specific surface type.",
      },
      {
        title: 'Pre-Treatment',
        description:
          'Stubborn stains and heavy buildup are treated with professional-grade cleaning solutions to break down contaminants.',
      },
      {
        title: 'Pressure Cleaning',
        description:
          'Using commercial equipment, we thoroughly clean your driveway with controlled pressure settings safe for your surface.',
      },
      {
        title: 'Optional Sealing',
        description:
          'Protect your investment with our premium sealing service that prevents future staining and extends surface life.',
      },
    ],
