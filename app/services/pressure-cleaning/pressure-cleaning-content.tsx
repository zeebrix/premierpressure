...
const benefits = [
  {
    ...
    description:
      'Complete peace of mind with comprehensive insurance coverage and proper licensing',
  },
  {
    icon: Award,
...
const professionalBenefits = [
  {
    ...
    description:
      'Regular pressure cleaning can boost your property value by up to 5-10%, making it a smart investment for homeowners and businesses alike.',
  },
  {
    icon: Shield,
    title: 'Protection & Longevity',
    description:
      'Removing mould, algae, and contaminants prevents permanent damage to surfaces, extending the life of your driveways, walls, and roofs.',
  },
  {
    icon: Home,
    title: 'Health & Safety',
    description:
      'Eliminate health hazards like mould, mildew, and slippery algae that can cause respiratory issues and slip-and-fall accidents.',
  },
  {
    icon: DollarSign,
    title: 'Cost-Effective Maintenance',
    description:
      'Professional pressure cleaning is far more affordable than replacing damaged surfaces, saving you thousands in the long run.',
  },
  {
    icon: Leaf,
    title: 'Eco-Friendly Solutions',
    description:
      "Our environmentally safe cleaning products and water-efficient techniques protect Perth's environment while delivering exceptional results.",
  },
  {
    icon: Award,
    title: 'Professional Expertise',
    description:
      'Our trained technicians know the right pressure, angle, and technique for each surface type, ensuring safe and effective cleaning every time.',
  },
];

export function PressureCleaningContent() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto">
              From driveways to roofs, limestone walls to pool areas - we deliver exceptional
              results for homes and businesses across Perth. Professional equipment, eco-friendly
              solutions, and unbeatable service.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl p-8 shadow-md border border-gray-100">
              <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                Pressure cleaning uses high-powered water spray to blast away dirt, grime, mould,
                and stains from your property&apos;s exterior surfaces. It&apos;s the fastest and
                most effective way to restore driveways, houses, roofs, and pathways to like-new
                condition.
              </p>

              <p className="text-lg text-gray-700 leading-relaxed">
                Our professional equipment and expertise deliver superior results that DIY methods
                simply can&apos;t match—safely cleaning every surface type without causing damage.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-br from-[#020B1C] to-[#06152E] rounded-2xl p-8 md:p-12 text-white">
            <div className="text-center mb-8">
              <p className="text-lg text-gray-300">
                ...
                between. No job too big or small!
              </p>
            </div>
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold mb-3">Get Your Free Quote Today</h2>
              ...
              <form className="space-y-3">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="house-washing" className="text-gray-900">
                      House Washing
                    </option>
                    <option value="driveway-cleaning" className="text-gray-900">
                      Driveway Cleaning
                    </option>
                    <option value="roof-cleaning" className="text-gray-900">
                      Roof Cleaning
                    </option>
                    <option value="concrete-cleaning" className="text-gray-900">
                      Concrete Cleaning
                    </option>
                    <option value="paver-cleaning" className="text-gray-900">
                      Paver Cleaning & Sealing
                    </option>
                    <option value="pool-patio" className="text-gray-900">
                      Pool Area & Patio
                    </option>
                    <option value="window-cleaning" className="text-gray-900">
                      Window Cleaning
                    </option>
                    <option value="limestone-cleaning" className="text-gray-900">
                      Limestone Cleaning
                    </option>
                    <option value="presale" className="text-gray-900">
                      Pre-Sale & End of Lease
                    </option>
