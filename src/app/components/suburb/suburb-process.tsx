          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              {index < steps.length - 1 && (
                <div className="hidden md:block absolute top-16 left-1/2 w-full h-0.5 bg-gradient-to-r from-[#0057FF] to-[#0057FF]/20 z-0">
                  <div className="absolute right-0 top-1/2 -translate-y-1/2 w-2 h-2 bg-[#0057FF] rounded-full"></div>
                </div>
              )}
              ...
              <div className="relative bg-gradient-to-br from-gray-50 to-white rounded-xl p-6 shadow-md hover:shadow-xl transition-shadow h-full flex flex-col min-h-[240px] border border-gray-200">
                {/* Number Badge */}
                <div className="absolute -top-4 -right-4 w-12 h-12 bg-[#0057FF] rounded-full flex items-center justify-center shadow-lg">
                  <span className="text-xl font-bold text-[#020B1C]">{index + 1}</span>
                </div>

                {/* Icon */}
                <div className="w-16 h-16 bg-[#020B1C] rounded-lg flex items-center justify-center mb-4">
