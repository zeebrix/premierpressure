...
import { HouseWashingBeforeAfter } from '@/app/components/service/house-washing-before-after';
...
export default function HouseWashingPage() {
  const serviceData = {
    ...
    subtitle:
      "Complete exterior cleaning that transforms your home's appearance and protects your investment",
    metaDescription:
      "Expert house washing services in Perth. Remove dirt, mould, and grime from all exterior surfaces. Restore your home's beauty. Free quotes. Fully insured.",
    ...
    process: [
      {
        ...
        description:
          "We inspect your home's exterior to identify surface types, problem areas, mould growth, and any delicate features requiring special attention.",
      },
      {
        title: 'Preparation & Protection',
        description:
          'Gardens, outdoor furniture, and fixtures are protected. We ensure all windows and doors are properly sealed and secure any loose items.',
      },
      {
        title: 'Pre-Treatment',
        description:
          'Heavily soiled areas, mould, and mildew are pre-treated with professional cleaning solutions that break down organic growth and stubborn stains.',
      },
      {
        title: 'Soft Wash or Pressure Clean',
        description:
          'We apply the appropriate cleaning method for each surface—gentle soft washing for painted and delicate surfaces, controlled pressure for brick and concrete.',
      },
      {
        title: 'Detail Work & Final Rinse',
        description:
          'Gutters, eaves, fixtures, and hard-to-reach areas receive detailed attention. Everything is thoroughly rinsed, leaving your home spotlessly clean.',
      },
    ],
