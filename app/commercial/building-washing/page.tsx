...
export const metadata: Metadata = {
  ...
  openGraph: { url: `${SITE_URL}/commercial/building-washing`, type: 'website', locale: 'en_AU', siteName: 'Premier Pressure Solutions WA', images: [{ url: 'https://www.premierpressuresolutions.com.au/og-image.jpg', width: 1200, height: 630 }] },
};
