...
export default function BurnsBeach() {
  const faqSchema = generateSuburbFAQSchema('Burns Beach');
  ...
  return (
    <>
      ...
      <StickyCallButton />
      <SuburbHero suburbName="Burns Beach" tagline="Pressure Cleaning Burns Beach - Premium Beachside Care" description="Expert pressure cleaning for Burns Beach's premium coastal properties. Professional services for this exclusive beachside community." />
      <SuburbServices suburbName="Burns Beach" />
      
      <BeforeAfterGallery />

      <SuburbWhyChoose suburbName="Burns Beach" />

      <SuburbProcess suburbName="Burns Beach" />

      <SuburbFAQ suburbName="Burns Beach" />
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0a1628] mb-8 text-center">About Pressure Cleaning in Burns Beach</h2>
            <div className="prose prose-lg max-w-none space-y-6 text-gray-700">
              <p>Burns Beach's prestigious beachside location demands expert pressure cleaning services. We provide specialized care for coastal properties, protecting your investment from salt spray and ocean elements.</p>
              <div className="bg-[#00d4ff]/10 border-l-4 border-[#00d4ff] p-6 mt-8">
                ...
                <p className="mb-0">First-time customers in Burns Beach receive 10% off their first pressure cleaning service. Call us today on <a href="tel:+61452579657" className="text-[#00d4ff] font-semibold hover:underline">0452 579 657</a> to book.</p>
              </div>
            </div>
          </div>
        </div>
