...
import { ConcreteBeforeAfter } from '@/app/components/service/concrete-before-after';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    url: `${SITE_URL}/services/concrete-cleaning`,
  },
};
...
export default function ConcreteCleaningPage() {
  const serviceData = {
    ...
    subtitle:
      'Expert cleaning for all concrete surfaces including exposed aggregate, driveways, patios, pathways, and pool surrounds',
    metaDescription:
      'Specialist concrete cleaning in Perth. Exposed aggregate restoration, driveway cleaning, patio cleaning. Remove stains, mould & grime. Free quotes.',
    ...
    process: [
      {
        ...
        description:
          'We inspect your concrete to identify the finish type (exposed aggregate, plain, stamped, etc.), assess staining levels, and test surface condition to determine the safest, most effective cleaning approach.',
      },
      {
        title: 'Pre-Treatment',
        description:
          "Stubborn stains including oil, rust, and organic growth are treated with specialized solutions. For exposed aggregate, we use gentle pre-treatments that won't affect the binding matrix.",
      },
      {
        title: 'Precision Cleaning',
        description:
          'Using commercial-grade equipment with carefully calibrated pressure settings, we thoroughly clean your concrete. Exposed aggregate receives special attention to reveal stones without dislodging them.',
      },
      {
        title: 'Post-Clean Inspection & Optional Sealing',
        description:
          'We inspect the cleaned surface to ensure complete stain removal and uniform appearance. We can then apply premium concrete sealer to protect against future staining and weather damage.',
      },
    ],
