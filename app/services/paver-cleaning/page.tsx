...
import { PaverBeforeAfter } from '@/app/components/service/paver-before-after';
...
export default function PaverCleaningPage() {
  const serviceData = {
    ...
    subtitle:
      'Transform your outdoor pavers with expert cleaning and sealing services that restore beauty and add lasting protection',
    metaDescription:
      'Expert paver cleaning and sealing in Perth. Remove stains, weeds, and organic growth. Restore and protect pavers. Free quotes. Fully insured.',
    ...
    process: [
      {
        ...
        description:
          'We assess your pavers, identify staining and problem areas, and prepare the area by removing furniture and clearing debris.',
      },
      {
        title: 'Deep Cleaning',
        description:
          'Using professional pressure cleaning equipment and appropriate cleaning solutions, we thoroughly clean pavers and remove all organic growth and staining.',
      },
      {
        title: 'Weed Removal & Resanding',
        description:
          'Weeds are eliminated, old sand is removed from joints, and new high-quality joint sand is applied and compacted for stability.',
      },
      {
        title: 'Sealing',
        description:
          'Premium paver sealer is applied to lock in sand, prevent weed growth, protect against stains, and enhance appearance with your choice of finish.',
      },
    ],
