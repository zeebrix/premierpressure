...
import { PoolPatioBeforeAfter } from '@/app/components/service/pool-patio-before-after';
...
export default function PoolPatioCleaningPage() {
  const serviceData = {
    ...
    subtitle:
      'Expert pressure cleaning services that restore your outdoor entertainment areas to pristine condition',
    metaDescription:
      'Professional pool area and patio cleaning services in Perth. Remove algae, grime, and stains from pool surrounds, patios, and alfresco areas. Free quotes. Fully insured.',
...
We use controlled pressure cleaning methods combined with appropriate cleaning solutions to remove stubborn staining, eliminate slip-causing algae, and restore the beauty of your outdoor entertainment areas. Our approach protects your pool equipment, preserves surface integrity, and ensures your family can safely enjoy your outdoor spaces.`,
    ...
    process: [
      {
        ...
        description:
          'We inspect your pool area and patio, identifying surface types, problem areas, and any sensitive features requiring special care during cleaning.',
      },
      {
        title: 'Area Preparation',
        description:
          'Outdoor furniture, plants, and surrounding areas are carefully protected before we begin. We prepare the surface and surrounding space to ensure a safe, effective clean without damage.',
      },
      {
        title: 'Specialised Cleaning',
        description:
          'Using appropriate pressure settings and professional cleaning solutions, we thoroughly clean all surfaces while protecting your pool and landscaping.',
      },
      {
        title: 'Final Inspection',
        description:
          'We ensure all areas are thoroughly cleaned, rinse away all cleaning agents, and leave your outdoor space ready to enjoy.',
      },
    ],
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes, removing algae and organic growth is one of the primary benefits of professional pool area cleaning. Algae creates dangerous slip hazards, especially on smooth surfaces like limestone or tiles. Our pressure cleaning effectively removes algae, moss, and biofilm that cause slippery conditions. For long-term prevention, we recommend our sealing services which inhibit algae regrowth and make future cleaning easier.',
      },
      {
        question: 'How often should pool areas and patios be cleaned?',
        answer:
          'Most Perth pool areas benefit from professional cleaning every 6-12 months, though this varies based on several factors. Shaded areas with tree coverage may need more frequent cleaning due to leaf staining and algae growth. High-traffic patios and areas with light-coloured surfaces also show dirt more quickly. Regular maintenance cleaning prevents deep staining and keeps surfaces safe and attractive year-round.',
      },
      {
        question: 'Can you clean while my pool is full?',
        answer:
          "Yes, we typically clean pool areas with the pool full and running. In fact, this is usually the best approach as the pool filter will help capture any debris. We take care to direct runoff away from the pool where possible and use pool-safe cleaning products. Our team protects pool equipment, skimmers, and return jets during the cleaning process. There's no need to drain or empty your pool.",
      },
    ],
  };
