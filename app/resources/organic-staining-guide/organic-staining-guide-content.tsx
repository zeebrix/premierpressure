...
function FAQItem({
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
      ...
      >
        <p className="text-gray-700 leading-relaxed px-6 pb-6">{answer}</p>
      </div>
    </div>
  );
}
...
const faqs = [
  {
    ...
    answer:
      "Organic staining is caused by living organisms including mould, mildew, algae, lichen, and moss. These organisms thrive in Perth's climate, especially in shaded, damp areas with poor air circulation. They feed on organic matter and moisture, creating unsightly stains and potential health hazards.",
  },
  {
    question: 'Is mould and mildew dangerous to my health?',
    answer:
      'Yes, mould and mildew can pose serious health risks. They release spores and mycotoxins that can trigger allergies, asthma attacks, respiratory infections, and other health issues. Children, elderly, and those with compromised immune systems are particularly vulnerable.',
  },
  {
    question: 'Can organic staining damage my property?',
    answer:
      "Absolutely. Organic growth can cause permanent discoloration, deteriorate paint and sealants, trap moisture leading to rot, damage roof tiles and shingles, and significantly reduce your property's curb appeal and value. Early intervention is crucial to prevent costly repairs.",
  },
  {
    question: 'How can I prevent organic staining?',
    answer:
      "Prevention strategies include ensuring proper drainage, trimming vegetation for better sunlight exposure, improving air circulation, scheduling regular professional cleaning, applying protective sealants, and addressing leaks promptly. Perth's climate requires proactive maintenance.",
  },
  {
    question: 'Should I use bleach to remove mould and algae?',
    answer:
      "While bleach may temporarily remove surface staining, it doesn't kill the root system and can damage surfaces, harm plants, and create toxic fumes. Professional pressure cleaning with eco-friendly solutions is more effective and safer for long-term results.",
  },
  {
    question: 'How often should I have my property professionally cleaned?',
    answer:
      "In Perth's climate, we recommend professional pressure cleaning every 12-18 months for most properties. Properties in shaded areas, near water, or with poor drainage may require cleaning every 6-12 months to prevent organic growth from becoming established.",
  },
];

export function OrganicStainingGuideContent() {
