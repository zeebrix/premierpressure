...
export default function ContactPage() {
  return (
    <>
      ...
      />
      <section className="relative overflow-hidden bg-[#0a1628] pt-32 pb-20 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-sm font-bold uppercase tracking-[0.2em] text-[#00d4ff] mb-4">
              Contact
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-6">
            <a
              ...
              className="rounded-lg border border-gray-200 p-6 shadow-sm hover:border-[#00d4ff] transition-colors"
            >
              <Phone className="w-8 h-8 text-[#00d4ff] mb-4" />
              <h2 className="text-xl font-bold text-[#0a1628] mb-2">Call</h2>
              <p className="text-gray-600 mb-3">For fast quotes and booking questions.</p>
              <p className="font-semibold text-[#0a1628]">0452 579 657</p>
            </a>
            ...
            >
              ...
              <h2 className="text-xl font-bold text-[#0a1628] mb-2">Email</h2>
              <p className="text-gray-600 mb-3">Send photos or job details for review.</p>
              <p className="font-semibold text-[#0a1628] break-all">info@ppsexteriorcleaning.com.au</p>
            </a>

            <div className="rounded-lg border border-gray-200 p-6 shadow-sm">
              <MapPin className="w-8 h-8 text-[#00d4ff] mb-4" />
              <h2 className="text-xl font-bold text-[#0a1628] mb-2">Service Area</h2>
              <p className="text-gray-600 mb-3">Residential and commercial exterior cleaning.</p>
              <p className="font-semibold text-[#0a1628]">Greater Perth, WA</p>
            </div>
          </div>
        </div>
      </section>
