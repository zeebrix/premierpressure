...
export const metadata: Metadata = {
  title: {
    absolute: 'Pressure Cleaning Preparation Checklist | Essential Pre-Cleaning Steps',
  },
  description:
  ...
  openGraph: { url: `${SITE_URL}/resources/preparation-checklist`, type: 'website', locale: 'en_AU', siteName: 'PPS Exterior Cleaning', images: [{ url: 'https://www.ppsexteriorcleaning.com.au/og-image.jpg', width: 1200, height: 630 }] },
};
...
const structuredData = {
  ...
  description:
    'Essential steps to prepare your property for pressure cleaning. Complete checklist to save time, ensure safety, and get the best results.',
