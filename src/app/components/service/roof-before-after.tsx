...
interface RoofBeforeAfterProps {
  serviceName: string;
}

const beforeAfterData = [
  {
    before: 'https://images.unsplash.com/photo-1663192166842-4bfdfb3cebed?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800',
    after: 'https://images.unsplash.com/photo-1655373617557-7138d45582d4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800',
    location: 'Scarborough',
    description: 'Roof tile moss removal',
  },
  {
    before: 'https://images.unsplash.com/photo-1760544137672-c22ce36ea818?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800',
    after: 'https://images.unsplash.com/photo-1553169507-38833977274b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800',
    location: 'Cottesloe',
    description: 'Weathered shingle restoration',
  },
  {
    before: 'https://images.unsplash.com/photo-1663219943592-3148202d2a4a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800',
    after: 'https://images.unsplash.com/photo-1632359552106-2599db65f51c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800',
    location: 'City Beach',
    description: 'Complete roof cleaning',
  },
];

export function RoofBeforeAfter({ serviceName }: RoofBeforeAfterProps) {
