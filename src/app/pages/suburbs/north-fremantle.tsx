...
export default function NorthFremantle() {
  const faqSchema = generateSuburbFAQSchema('North Fremantle');
  ...
  return (
    <>
      ...
      <SuburbHero suburbName="North Fremantle" tagline="Pressure Cleaning North Fremantle - Historic & Riverside Care" description="Expert pressure cleaning for North Fremantle's historic homes and riverside properties. Professional services for Fremantle's charming northern suburb." />
      <SuburbServices suburbName="North Fremantle" />
      <BeforeAfterGallery />
      <SuburbWhyChoose suburbName="North Fremantle" />

      <SuburbProcess suburbName="North Fremantle" />

      <SuburbFAQ suburbName="North Fremantle" />
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0a1628] mb-8 text-center">About Pressure Cleaning in North Fremantle</h2>
            <div className="prose prose-lg max-w-none space-y-6 text-gray-700">
              <p>North Fremantle's historic homes and riverside properties require professional pressure cleaning with special care for heritage features. We provide expert services for period homes and modern properties in this charming suburb.</p>
              <div className="bg-[#00d4ff]/10 border-l-4 border-[#00d4ff] p-6 mt-8">
                ...
                <p className="mb-0">First-time customers in North Fremantle receive 10% off their first pressure cleaning service. Call us today on <a href="tel:+61452579657" className="text-[#00d4ff] font-semibold hover:underline">0452 579 657</a> to book.</p>
              </div>
            </div>
          </div>
        </div>
