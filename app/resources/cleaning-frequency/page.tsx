...
export const metadata: Metadata = {
  title: {
    absolute: 'How Often Should You Pressure Clean in Perth? | Maintenance Schedule Guide',
  },
  description:
...
const articleSchema = {
  ...
  description:
    "Learn the optimal pressure cleaning frequency for Perth's unique climate. Expert recommendations for driveways, houses, roofs and more.",
...
const combinedSchema = combineSchemas(generateLocalBusinessSchema(), articleSchema);
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <section className="prose prose-lg max-w-none mb-12">
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
              Perth&apos;s unique climate&mdash;hot, dry summers and mild, wet winters&mdash;creates the perfect conditions for dirt, mould, and algae buildup on your property. Regular pressure cleaning isn&apos;t just about aesthetics; it&apos;s essential maintenance that protects your investment and prevents costly damage.
            </p>
              ...
              {[
                {
                  ...
                  reasoning:
                    'Concrete is porous and absorbs oils, dirt, and organic matter. Annual cleaning prevents permanent staining and maintains curb appeal.',
                  signs: [
                ...
                },
                {
                  ...
                  reasoning:
                    "Perth's dust and pollution settle on exterior walls. Painted surfaces particularly benefit from regular cleaning to prevent deterioration and maintain paint adhesion.",
                  signs: [
                ...
                },
                {
                  ...
                  reasoning:
                    'Roofs accumulate moss, lichen, and debris that can damage tiles and reduce reflective properties, increasing cooling costs. Regular cleaning extends roof life significantly.',
                  signs: [
                ...
                },
                {
                  ...
                  reasoning:
                    'Pavers accumulate dirt in joints and are prone to weed growth. Regular cleaning maintains the integrity of joint sand and prevents paver movement.',
                  signs: [
                ...
                },
                {
                  ...
                  reasoning:
                    'Constant moisture exposure promotes algae and mould growth, creating slip hazards. Safety and aesthetics both demand regular maintenance.',
                  signs: [
                    'Green algae buildup',
                ...
                },
                {
                  ...
                  reasoning:
                    'High foot traffic and business image requirements demand more frequent cleaning. First impressions matter for customer-facing businesses.',
                  signs: [
