...
export const metadata: Metadata = {
  title: {
    absolute: 'DIY vs Professional Pressure Cleaning | Complete Cost & Risk Comparison',
  },
  description:
...
const structuredData = {
  ...
  description:
    'Compare the real costs, risks, and results of DIY pressure cleaning versus hiring professionals. Make an informed decision for your Perth property.',
              ...
              {[
                {
                  ...
                  consequence:
                    'Etched concrete, damaged roof tiles, stripped paint, splintered timber - repairs cost $500-$5,000+',
                  realExample:
                    '"I thought more pressure = better clean. Now my driveway looks like the moon and needs resurfacing." - Perth homeowner',
                },
                {
                  mistake: 'Wrong Cleaning Angle',
                  risk: 'Water damage and surface pitting',
                  consequence:
                    'Water forced under roof tiles, into walls, or damaged mortar - structural repair costs $1,000-$10,000',
                  realExample:
                    '"Water got under my tiles and into the ceiling. The mould remediation cost me $3,500." - Wanneroo resident',
                },
                {
                  mistake: 'Incorrect Chemical Use',
                  risk: 'Plant death and surface discoloration',
                  consequence:
                    'Dead landscaping, permanent staining, environmental damage - replacement costs $500-$3,000',
                  realExample:
                    '"Used the wrong cleaner on limestone. Permanent brown stains. Had to paint over it." - Subiaco homeowner',
                },
                {
                  mistake: 'Inadequate Safety Precautions',
                  risk: 'Personal injury',
                  consequence:
                    'Falls from ladders, eye injuries, cuts from pressure - medical bills and time off work',
                  realExample:
                    '"Fell off a ladder cleaning the second story. Broken arm and 6 weeks off work." - Joondalup resident',
                },
                {
                  mistake: 'Underestimating Time Required',
                  risk: 'Incomplete job or burnout',
                  consequence:
                    'Patchy results, wasted weekend, rental equipment charges add up',
                  realExample:
                    '"Rented equipment for a day. Took me 3 days. Ended up costing more than a pro quote." - Canning Vale homeowner',
                },
              ].map((item, index) => (
                ...
                {[
                  {
                    ...
                    description:
                      'If you already own equipment and want to do light maintenance between professional cleans every 6 months',
                  },
                  {
                    title: 'Simple Concrete Paths',
                    description:
                      'Small, flat concrete areas with no special finishes or nearby delicate surfaces',
                  },
                  {
                    title: 'You Have Experience',
                    description:
                      "You've done it before successfully and understand pressure settings and techniques",
                  },
                  {
                    title: 'Genuinely Enjoying It',
                    description:
                      'Some people find it therapeutic! If you have time and enjoy the work, go for it',
                  },
                ].map((scenario, index) => (
