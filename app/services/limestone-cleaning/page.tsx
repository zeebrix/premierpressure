...
import { LimestoneBeforeAfter } from '@/app/components/service/limestone-before-after';
...
export default function LimestoneCleaningPage() {
  const serviceData = {
    ...
    subtitle:
      'Specialist cleaning and restoration services that bring your limestone surfaces back to life',
    metaDescription:
      'Expert limestone cleaning services in Perth. Restore walls, pavers, and features with gentle, effective cleaning. Free quotes. Fully insured.',
    ...
    process: [
      {
        title: 'Assessment',
        description:
          'We carefully inspect your limestone to identify the type of staining, degree of organic growth, and determine the safest cleaning approach.',
      },
      {
        title: 'Pre-Treatment',
        description:
          'Organic growth and stubborn stains are treated with limestone-safe cleaning solutions designed to break down contaminants without damaging the stone.',
      },
      {
        title: 'Gentle Cleaning',
        description:
          'Using low-pressure techniques and soft washing methods, we thoroughly clean your limestone while protecting its delicate surface.',
      },
      {
        title: 'Sealing (Optional)',
        description:
          'Apply premium limestone sealer to protect against future staining, enhance colour, and make maintenance easier.',
      },
    ],
    ...
    faqs: [
      {
        ...
        answer:
          'Limestone cleaning costs in Perth typically range from $200 to $600 depending on the size of the area, height (for walls), accessibility, and severity of staining. We provide free quotes after assessing your specific limestone surfaces. Factors affecting cost include surface area, level of organic growth or staining, height and access requirements, and whether sealing is required.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Black staining on limestone is typically caused by algae, mould, or lichen growth. The porous nature of limestone combined with Perth climate conditions create ideal environments for these organisms to thrive, especially in shaded or damp areas. The black staining penetrates deep into the stone rather than sitting on the surface, which is why simple washing cannot remove it. Professional cleaning with appropriate biocidal treatments is required to kill the organisms and remove the staining.',
      },
      {
        question: 'How often should limestone be cleaned?',
        answer:
          'Most Perth limestone surfaces benefit from professional cleaning every 2-3 years. However, limestone in shaded areas, near gardens, or exposed to sprinkler systems may need annual cleaning due to faster organic growth. Regular cleaning prevents deep staining that becomes harder to remove over time. After cleaning, applying a quality sealer can extend the time between cleanings and make future maintenance easier.',
      },
      {
